...
public class SearchResultComparator implements Comparator<DashboardEntityWithCounts> {

    @Override
    public int compare(DashboardEntityWithCounts e0, DashboardEntityWithCounts e1) {
