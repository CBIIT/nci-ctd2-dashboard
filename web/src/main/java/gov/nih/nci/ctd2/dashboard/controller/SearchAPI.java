...
public class SearchAPI {
    ...
    public ResponseEntity<String> getSubmission(@PathVariable String term,
        ...
        List<SubjectBrowse> allSubjects = new ArrayList<SubjectBrowse>();
        ...
        for (DashboardEntityWithCounts resultWithCount : results) {
            ...
            List<? extends DashboardEntity> observations = webServiceUtil.getObservations(subject, centerIncluded,
                    rolesIncluded, Arrays.asList(tiersIncluded));
