                    ...
                    <div class="span12">
                        <div class="featurette" id="overview-text">
                            ...
                            <p class="lead firstlead">
                                <b>The CTD<sup>2</sup> Dashboard</b> hosts analyzed data and other evidence generated by the <b>CTD<sup>2</sup> Network</b>.
                ...
                <div class="span9">
                    <table id="cellsample-details-grid" class="table table-bordered table-striped">
                        ...
                        <tr>
                            <th>Genomic alterations</th>
                            <td>
                                <a class="btn btn-small" href="http://www.cbioportal.org/public-portal/case.do?cancer_study_id=cellline_ccle_broad&case_id={{cbioPortalId}}" target="blank">view in cBioPortal <i class="icon-share"></i></a>
                            </td>
                        </tr>
                    </table>
                </div>
