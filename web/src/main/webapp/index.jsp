  ...
  <body>
                    ...
                    <div class="span9">
                        <div class="featurette" id="overview-text">
                            ...
                            <p class="lead firstlead">
                                ...
                                It provides supporting evidence with links to data, references, and the validation strength of evidence referred by “<a href="http://www.ncbi.nlm.nih.gov/pubmed/27401613" target="_blank" data-toggle="tooltip" id="tierTooltip">Tier</a>.”
    ...
    <script type="text/template" id="help-navigate-tmpl">
        <div class="help-navigate-text-container">
            ...
            <p>
                The <b>subjects</b> from CTD<sup>2</sup> Network studies are ordered by relevance based on the number of <b>observations</b> associated with a <b>submission</b>, the <b>Tiers</b> of these <b>observations</b>, and the number of different <b>Centers</b> providing <b>observations</b> about that particular <b>subject</b>.
            </p>
